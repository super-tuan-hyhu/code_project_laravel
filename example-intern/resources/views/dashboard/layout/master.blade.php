...
<div class="group-data-[sidebar-size=sm]:min-h-sm group-data-[sidebar-size=sm]:relative">
    ...
    <!-- sidebar -->
    @include('dashboard.layout.sitebar')
    <!-- Left Sidebar End -->
...
<script src="../assets/js/pages/apps-user-list.init.js"></script>
...
<script>
    document.getElementById('fileInput').addEventListener('change', function(event) {
        ...
        if (file) {
            ...
            fileSize.innerHTML = `<strong>${(file.size / 1024 / 1024).toFixed(2)}</strong> MB`;
...
<script>
    function checkColorSize(){
        var colors = document.querySelectorAll('input[name="name_color"]:checked');
        var sizes = document.querySelectorAll('input[name="nameSizeee"]:checked');

        if (colors.length === 0 || sizes.length === 0) {
            alert("Bạn phải chọn Màu và Kích thước");
            return false;
        }
        return true;
    }
...
<script src="../assets/js/dataProvince.js"></script>
<script src="../assets/js/imageColor.js"></script>
<script src="../assets/js/inputJavascript.js"></script>
<script src="../assets/js/counter/cartProducts.js"></script>
<script src="../assets/js/counterUpdate/updateCounter.js"></script>
<script src="../assets/js/fetchUser/fetchUser.js"></script>
