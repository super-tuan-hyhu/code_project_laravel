    ...
    <div class="group-data-[sidebar-size=lg]:ltr:md:ml-vertical-menu group-data-[sidebar-size=lg]:rtl:md:mr-vertical-menu group-data-[sidebar-size=md]:ltr:ml-vertical-menu-md group-data-[sidebar-size=md]:rtl:mr-vertical-menu-md group-data-[sidebar-size=sm]:ltr:ml-vertical-menu-sm group-data-[sidebar-size=sm]:rtl:mr-vertical-menu-sm pt-[calc(theme('spacing.header')_*_1)] pb-[calc(theme('spacing.header')_*_0.8)] px-4 group-data-[navbar=bordered]:pt-[calc(theme('spacing.header')_*_1.3)] group-data-[navbar=hidden]:pt-0 group-data-[layout=horizontal]:mx-auto group-data-[layout=horizontal]:max-w-screen-2xl group-data-[layout=horizontal]:px-0 group-data-[layout=horizontal]:group-data-[sidebar-size=lg]:ltr:md:ml-auto group-data-[layout=horizontal]:group-data-[sidebar-size=lg]:rtl:md:mr-auto group-data-[layout=horizontal]:md:pt-[calc(theme('spacing.header')_*_1.6)] group-data-[layout=horizontal]:px-3 group-data-[layout=horizontal]:group-data-[navbar=hidden]:pt-[calc(theme('spacing.header')_*_0.9)]">
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
            <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                ...
                @if(Session::has('messageLog'))
                    <script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.2/sweetalert.min.js" integrity="sha512-AA1Bzp5Q0K1KanKKmvN/4d3IRKVlv9PYgwFPvm32nPO6QS8yH1HO7LbgB1pgiOxPtfeg5zEn2ba64MUcqJx6CA==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
                    <script>
                        swal("Message", "{{ Session::get("messageLog") }}", "success", {
                            button:true,
                            button:"OK",
                        })
                    </script>
            ...
            <div class="grid grid-cols-12 2xl:grid-cols-12 gap-x-5">
                ...
                <div class="col-span-12 card md:col-span-6 lg:col-span-3 2xl:col-span-2">
                    <div class="text-center card-body">
                        ...
                        <h5 class="mt-4 mb-2">$<span class="counter-value" data-target="{{ $total }}"></span>k</h5>
                ...
                <div class="col-span-12 card md:col-span-6 lg:col-span-3 2xl:col-span-2">
                    <div class="text-center card-body">
                        ...
                        <h5 class="mt-4 mb-2"><span class="counter-value" data-target="{{ $countStatus }}"></span></h5>
                ...
                <div class="col-span-12 card md:col-span-6 lg:col-span-3 2xl:col-span-2">
                    <div class="text-center card-body">
                        ...
                        <h5 class="mt-4 mb-2"><span class="counter-value" data-target="{{ $cancel }}">0</span></h5>
                            ...
                            <table class="w-full whitespace-nowrap">
                                ...
                                <tbody>
                                    @foreach($order as $key => $list)
                                        <tr>
                                            <td class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500"><a href="apps-ecommerce-order-overview.html">#TWT{{ $list->barCode }}</a></td>
                                            <td class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500">{{ $list->accepted }}</td>
                                            <td class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500">{{ $list->country }}</td>
                                            <td class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500">{{ $list->updated_at->format('Y-m-d') }}</td>
                                            <td class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500">{{ $list->payment_methods }}</td>
                                            <td class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500">{{ $list->email }}</td>
                                            <td class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500">${{ $list->total }}</td>
                        ...
                        <div>
                            <div class="grid mt-3 xl:grid-cols-2">
                                <div class="flex items-center gap-2">
                                    ...
                                    <p class="mb-0 text-slate-500 dark:text-zink-200">This Month: <span class="font-medium text-slate-800 dark:text-zink-50">${{ $total }}</span></p>
                                </div>
                            </div>
                        </div>
                        <h6 class="mt-4 mb-3">Top Customer</h6>
                        <ul class="divide-y divide-slate-200 dark:divide-zink-500">
                            @foreach($orderUser as $list)
                ...
                <div class="col-span-12 card lg:col-span-6 2xl:col-span-3">
                    <div class="card-body">
                        <div class="flex items-center mb-3">
                            <h6 class="grow text-15">Categories</h6>
                            <div class="relative dropdown shrink-0">
                        ...
                        <ul class="divide-y divide-slate-200 dark:divide-zink-500">
                            @foreach($category as $list)
                                <li class="flex items-center gap-3 py-2 first:pt-0 last:pb-0">
                                    ...
                                    <div class="grow">
                                        <h6 class="font-medium">{{ $list->name }}</h6>
                                        <p class="text-slate-500 dark:text-zink-200">{{ $list->countProduct }} Products</p>
                                        <p class="text-slate-500 dark:text-zink-200">Max : ${{ $list->maxProducts }}, Min : ${{ $list->minProducts }}</p>
                                    </div>
                                    <div class="shrink-0">
                                        <h6>${{ $list->avgProducts }}</h6>
                                    </div>
                                </li>
                            @endforeach
                        </ul>
{{--                        <div id="salesThisMonthChart" class="apex-charts" data-chart-colors='["bg-sky-100", "bg-orange-100", "bg-sky-500", "bg-orange-500"]' dir="ltr"></div>--}}
                ...
                <div class="col-span-12 card lg:col-span-6 2xl:col-span-3">
                    <div class="card-body">
                        ...
                        <ul class="divide-y divide-slate-200 dark:divide-zink-500">
                            @foreach($orderDetail as $key => $list)
                                <li class="flex items-center gap-3 py-2 first:pt-0 last:pb-0">
                                    <div class="flex items-center justify-center w-10 h-10 rounded-md bg-slate-100 dark:bg-zink-600">
                                        <img src="{{ Storage::url($list->img) }}" alt="" class="h-6">
                                    </div>
                                    ...
                                    <div class="shrink-0">
                                        <h6 class="shrink-0"><i data-lucide="shopping-cart" class="inline-block align-middle size-4 text-slate-500 dark:text-zink-200 ltr:mr-1 rtl:ml-1"></i>{{ $list->totalNumber }}</h6>
                                    </div>
                                </li>
                            @endforeach
                        </ul>
